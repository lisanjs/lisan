...
[`lisan.toNumber`](/docs/full-api-reference#lisantonumbernumber) Localization Helper
...
[`lisan.toCurrency`](/docs/full-api-reference#lisantocurrencyamount)
...
[`lisan.toOrdinal`](/docs/full-api-reference#lisantoordinalnumber)
Localization Helper and it has the following type definition.
